...
namespace UsefulTools.Runtime.Extensions {
    public static class ListExtensions {
        ...
        /// <summary>
        /// Clears an existing list and fills it with the elements of the provided collection.
        /// </summary>
        /// <param name="list">The original list to be copied.</param>
        /// <returns>An original list that is filled with the elements of the provided collection.</returns>
        ...
        public static IList<T> Shuffle<T>(this IList<T> list, int iterationsCount) {
