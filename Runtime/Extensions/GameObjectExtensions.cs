...
namespace UsefulTools.Runtime.Extensions {
    public static class GameObjectExtensions {
        ...
        public static bool IsNullRef(this GameObject go) => ReferenceEquals(go, null);

        public static bool IsNotNullRef(this GameObject go) => !ReferenceEquals(go, null);
        ...
        public static void ResetLocalTransformation(this GameObject gameObject) => gameObject.transform.ResetToLocal();

        public static void ResetWorldTransformation(this GameObject gameObject) => gameObject.transform.ResetToWorld();
        ...
        public static string Path(this GameObject gameObject) =>
            "/" + string.Join("/", gameObject.GetComponentsInParent<Transform>()
                                 .Select(t => t.name)
                                 .Reverse()
                                 .ToArray());
